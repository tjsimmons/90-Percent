...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rate.rate'
        db.alter_column(u'details_rate', 'rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=4))

        # Changing field 'Rate.effective_from'
        db.alter_column(u'details_rate', 'effective_from', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Rate.rate'
        db.alter_column(u'details_rate', 'rate', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=5, decimal_places=4))

        # Changing field 'Rate.effective_from'
        db.alter_column(u'details_rate', 'effective_from', self.gf('django.db.models.fields.DateField')(default=None))
