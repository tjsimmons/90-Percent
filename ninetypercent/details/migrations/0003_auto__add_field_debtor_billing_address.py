...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Debtor.billing_address'
        db.add_column(u'details_debtor', 'billing_address',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['details.Address'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Debtor.billing_address'
        db.delete_column(u'details_debtor', 'billing_address_id')
    ...
    models = {
        ...
        u'details.debtor': {
            ...
            'billing_address': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['details.Address']", 'null': 'True'}),
