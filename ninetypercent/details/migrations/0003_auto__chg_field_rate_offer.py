...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rate.offer'
        db.alter_column(u'details_rate', 'offer', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'Rate.offer'
        db.alter_column(u'details_rate', 'offer', self.gf('django.db.models.fields.CharField')(max_length=10))
