...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'details_reading', (
            ...
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 6, 0, 0))),
        ...
        # Adding field 'Premise.reading'
        db.add_column(u'details_premise', 'reading',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['details.Reading'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Premise.reading'
        db.delete_column(u'details_premise', 'reading_id')
    ...
    models = {
        u'details.address': {
            ...
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 6, 0, 0)'}),
