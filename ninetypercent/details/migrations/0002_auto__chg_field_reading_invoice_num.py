...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reading.invoice_num'
        db.alter_column(u'details_reading', 'invoice_num', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Reading.invoice_num'
        db.alter_column(u'details_reading', 'invoice_num', self.gf('django.db.models.fields.IntegerField')(default=None))
    ...
    models = {
        u'details.address': {
            ...
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 21, 0, 0)'}),
